...
class FindOrCreateUser
  ...
  def create_user(options)
    user                       = User.create do |user|
      ...
      user.salesforce_contact_id = options[:salesforce_contact_id]
      user.faculty_status        = options[:faculty_status]
      user.role                  = options[:role]
      user.school_type           = options[:school_type]
      user.is_test               = options[:is_test]
